...
const missionsTitle_book3 = document.querySelector(".missions__title--book3");
const missionsLinks_book3 = document.querySelector(".missions__links--book3");
...
function missionToggle_book3() {
    missionsLinks_book3.classList.toggle("removeContent");
}
...
if (missionsTitle_book3) {
    missionsTitle_book3.addEventListener("click", missionToggle_book3);
}